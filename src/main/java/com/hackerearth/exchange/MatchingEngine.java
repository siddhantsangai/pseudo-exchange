...
public class MatchingEngine {
    ...
    public void pushToBuyOrderBook(Order order) {
        ...
        PortfolioManager.managePortfolioOrders(order, portfolio, OrderManagementFlag.ADD);
        ...
        try {
            ...
            if (bestBuyOrder.getPrice() >= bestSellOrder.getPrice()) {
                ...
                if (buyQty > sellQty) {
                    ...
                    PortfolioManager.managePortfolioOrders(bestSellOrder, sellerPortfolio, OrderManagementFlag.REMOVE);
                    ...
                    PortfolioManager.managePortfolioOrders(bestBuyOrder, buyerPortfolio, OrderManagementFlag.REMOVE);
